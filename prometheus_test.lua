...
function TestPrometheus:testCollect()
  local hist3 = self.p:histogram("b1", "Bytes", {"var", "stale"}, {100, 2000})
  self.counter1:inc(5)
  ...
  assert(find_idx(ngx.printed, 'b1_bucket{var="ok",stale="true",le="100"} 2') ~= nil)
  assert(find_idx(ngx.printed, 'b1_sum{var="ok",stale="true"} 5250') ~= nil)
